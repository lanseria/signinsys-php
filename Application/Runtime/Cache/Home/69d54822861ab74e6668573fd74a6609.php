			...
			<table class="table table-hover">
				...
				<tbody>
					<?php if(is_array($msglist)): foreach($msglist as $key=>$msg): ?><tr>
							<td><?php echo ($msg["pid"]); ?></td>
							<td><a href="<?php echo U('/Home/Msg/vote');?>?pid=<?php echo ($msg["pid"]); ?>"><?php echo ($msg["pname"]); ?></a></td>
							<td><?php echo ($msg["pdes"]); ?></td>
							<td><?php echo ($msg["pcreatetime"]); ?></td>
							<td><?php echo ($msg["penroll"]); ?>人</td>
