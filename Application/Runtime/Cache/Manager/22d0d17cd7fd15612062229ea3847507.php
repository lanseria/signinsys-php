...
<div class="row placeholders">
	...
	<form class="form-inline col-sm-2 col-sm-offset-6">
		<div class="form-group">
			<select class="form-control" name="data" id="data" onchange="changeid('export',this.value)">
		...
		<a type="submit" id="sub" class="btn btn-default" href="/Manager/Index/export.html?sid=<?php echo ($msg[0]["pid"]); ?>">查找</a>
		<a type="submit" id="subd" class="btn btn-default" href="/Manager/Index/download.html?pid=<?php echo ($msg[0]["pid"]); ?>&type=Excel5">下载xls</a>
		<a type="submit" id="subd" class="btn btn-default" href="/Manager/Index/download.html?pid=<?php echo ($msg[0]["pid"]); ?>&type=Excel2007">下载xlsx</a>
	</form>
</div>
